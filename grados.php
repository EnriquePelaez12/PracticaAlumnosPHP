    ...
    <header>          
       <div class="container-fluid menu" >
         <nav class="navbar navbar-expand-lg container">
            <a class="navbar-brand text-light bg-gray" href="#"><img src="styles/img/logo.png" class="img-fluid" width="60" alt="Multiversos">Tutorial Crud en PHP con 'Multiversos'</a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
              <span class="navbar-toggler-icon"></span>
            </button>
            <button class="btn btn-danger">Cintas</button>
    ...
    <div class="row">
      <div class="col-md-3 ">
          <div class="card ml-auto sombra">
              <div class="card-body">
                <h4 class="card-title text-center">Ingresar usuariosss</h4>

                <form action="controllerGrados.php" method="post" id="guarda">
                ...
                <div class="form-group">
                  <label for="gActual">Grado Actual</label>
                  <input type="text" class="form-control" id="gActual" name="gActual" placeholder="gActual">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="idAlumno" name="idAlumno" placeholder="idAlumno">
                </div>
